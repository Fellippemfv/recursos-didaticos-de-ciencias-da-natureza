    ...
    <main className="flex min-h-screen flex-col items-center justify-between">
      <div className="max-w-5xl mx-auto p-6 space-y-12">
        ...
        <section className="bg-blue-100 p-8 rounded-lg shadow-md text-center">
          ...
          <p className="text-lg">
            Esta plataforma foi criada para facilitar o acesso a recursos
            didáticos interativos, como experimentos, jogos e dinâmicas, que
            auxiliem professores e estudantes. Nosso propósito é apoiar o
            aprendizado de forma lúdica e acessível, oferecendo um repositório
            de atividades educacionais práticas e inovadoras. Queremos
            contribuir para a educação, promovendo uma experiência de ensino
            mais enriquecedora e interativa.
          </p>
        </section>
        ...
        <section>
          ...
          <div className="flex flex-wrap justify-center gap-8">
            ...
            <div className="w-full md:w-1/4 bg-white p-4 rounded-lg shadow-md text-center">
              ...
              <p className="mt-2 text-sm">
                Responsável pelo desenvolvimento da plataforma e pela
        ...
        <section className="bg-blue-100 p-8 rounded-lg shadow-md">
          ...
          <p className="text-lg mb-4 text-center">
            Entre em contato conosco ou envie suas sugestões para melhorar a
            plataforma!
          </p>
          <ul className="list-disc list-inside text-center space-y-2">
            <li>
              <span className="font-semibold">E-mail:</span>{" "}
              contato@plataformaeducacional.com
            </li>
            <li>
